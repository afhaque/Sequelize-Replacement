...
* Make sure you have a MYSQL database named "todolist" created on your machine before class starts. Try and familarize yourself with how the todolist app is supposed to work.
...
INSTRUCTIONS:
 ...
 6) BIG HINT: you will need to pass in an options object with a "where" attribute into both methods in order to filter these queries to target the Todos we want. Learn more here http://docs.sequelizejs.com/en/latest/docs/querying/#where
...
* Slack out the Sequelize CRUD actions cheat sheet (../Resources/SequelizeCRUDActionsCheatSheet.pdf)
...
* Inform students that Sequelize does have built in validations and flags we can include with our models.
