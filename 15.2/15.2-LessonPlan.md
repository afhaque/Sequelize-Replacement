...
### 13. Instructor: Explain Error Handling (5 mins)
...
* Answer any remaining questions and slack out [`Solved`](Activities/4-Sequelize-Validations/Solved) before starting the next activity.

### 14. Students Do: Final Activity (30 mins)

* Slack out the following file and Instructions:
	* File: [`Unsolved`](Activities/5-Blog-CMS/Unsolved)
	* ```
	/* INSTRUCTIONS:
	 * 1) Open the file slacked out to you
	 * 2) Create a new database and named `blogger`
	 * 3) Run `npm install` and then `node server`
	 * 4) Navigate to the api-routes.js file and fill in the missing information inside of each route.
	 * 5) Test the application by navigating to localhost:8080
	 * -/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/ */
	```
