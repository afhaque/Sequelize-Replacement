...
* Otherwise go through the solution in [`2-Blog-CRUD-Solved`](Activities/2-Blog-CRUD/2-Blog-CRUD-Solved) together. Have students explain to you what each method does, what the "where" attribute is doing in the methods using it.
